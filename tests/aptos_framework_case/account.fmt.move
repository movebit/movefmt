module aptos_framework::account {
    ...
    public entry fun rotate_authentication_key(
        ...
        let new_auth_key = assert_valid_rotation_proof_signature_and_get_auth_key(to_scheme,
    ...
    public(friend) fun create_framework_reserved_account(addr: address)
        ...
        assert!(addr == @0x1 || addr == @0x2 || addr == @0x3 || addr == @0x4 || addr == @
            0x5 || addr == @0x6 || addr == @0x7 || addr == @0x8 || addr == @0x9 || addr == @
                0xa,
