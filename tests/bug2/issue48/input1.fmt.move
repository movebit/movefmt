module test {
    inline fun swap_within_escrow<Coin0, LP0, Coin1, LP1>(
        ...
        if (true) {
            (quote_volume, integrator_fee, emojicoin_1_proceeds) =
                swap_within_escrow_for_direction<Coin0, LP0, Coin1, LP1>(
                    swapper,
                    swapper_address,
                    market_address_0,
                    market_address_1,
            ...
            (quote_volume, integrator_fee, emojicoin_0_proceeds) =
                swap_within_escrow_for_direction<Coin1, LP1, Coin0, LP0>(
                    swapper,
                    swapper_address,
                    market_address_1,
                    market_address_0,
